...
20 năm Nhã nhạc được công nhận Di sản Văn hóa Phi vật thể đại diện của nhân loại, Festival Huế 2023 với Chủ đề:
 “Di sản Văn hóa với hội nhập và phát triển”', 4, 3,'KDL Bà Nà – Sơn Trà – Hội An - La Vang - Động Phong Nha – Làng hương Thủy Xuân - Huế',
...
,4,3,'Phú Quốc - Thiên đường giải trí VinWonders - Vinpearl Safari - Hòn Thơm Nature Park - Cáp Treo Vượt Biển - Công Viên Nước Aquatopia'
