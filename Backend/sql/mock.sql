...
INSERT INTO `tour`(details,duration,`name`,numOfPeople,thumbnail_url,img1_url,img2_url,img3_url,img4_url,price,startDest,saleRate,`type`) VALUES
('Ngày 1 - Săn Mây Cầu Đất - Cánh Đồng Điện Gió - Vườn Dâu - Vườn Hoa Cẩm Tú Cầu - Thưởng thức Trà Long Đỉnh','1 ngày', 'City Đà Lạt - Săn mây đón bình minh - Thưởng thức Trà Long Đình', 12,'','','','','',7900000,'Hà Nội',40,'STANDARD'),
