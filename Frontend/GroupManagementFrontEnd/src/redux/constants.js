...
export const GET_LIST_BOOKING_SELECTED_ROWS = "GET_LIST_BOOKING_SELECTED_ROWS";
export const GET_BOOKING_CHECKOUT_INFO = "GET_BOOKING_CHECKOUT_INFO";
export const GET_TRIP_BY_ID_SUCCESS = "GET_TRIP_BY_ID_SUCCESS";

//contact

export const GET_LIST_CONTACT_SELECTED_ROWS = "GET_LIST_CONTACT_SELECTED_ROWS";
